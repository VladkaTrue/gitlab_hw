# Домашнее задание к занятию "Репликация и масштабирование. Часть 1" - `Чернышев Владислав`
...
![12-6-1](https://github.com/VladkaTrue/gitlab_hw/blob/hw_12-06/img/12-6-1.png?raw=true)
...
![12-6-2](https://github.com/VladkaTrue/gitlab_hw/blob/hw_12-06/img/12-6-2.png?raw=true)

#### На мастере: 
```sql
create database hw_12_6;
```
#### На слэйве:
```sql
show databases;
...
![12-6-3](https://github.com/VladkaTrue/gitlab_hw/blob/hw_12-06/img/12-6-3.png?raw=true)
